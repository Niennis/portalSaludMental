              ...
              <ul>
                {/* <li className="submenu" >
                  ...
                  <ul style={{ display: sidebar === 'Dashboard' ? 'block' : "none" }} className='menu-items'>
                    <li>
                      <Link className={props?.activeClassName === 'admin-dashboard' ? 'active' : ''} to="/admin-dashboard">Dashboard Admin</Link>
                    </li>
                    <li>
                      <Link className={props?.activeClassName === 'doctor-dashboard' ? 'active' : ''} to="/doctor-dashboard">Dashboard Doctores</Link>
                    </li>
                    <li>
                      <Link className={props?.activeClassName === 'patient-dashboard' ? 'active' : ''} to="/patient-dashboard">Dashboard Pacientes</Link>
                    </li>
                  </ul>
                </li> */}
                <li className="submenu">
                  ...
                  <ul style={{ display: sidebar === 'Doctors' ? 'block' : 'none' }} className="menu-items1">
                    <li>
                      <Link className={props?.activeClassName === 'doctor-list' ? 'active' : ''} to="/doctorlist">Lista de Profesionales</Link>
                    </li>
                    <li>
                      <Link className={props?.activeClassName === 'add-doctor' ? 'active' : ''} to="/add-doctor">Agregar Profesional</Link>
                    </li>
                    {/* <li>
                      <Link className={props?.activeClassName === 'edit-doctor' ? 'active' : ''} to="/editdoctor">Editar Doctor</Link>
                    </li> */}
                    <li>
                      <Link className={props?.activeClassName === 'doctor-profile' ? 'active' : ''} to="/doctorprofile">Perfil Profesional</Link>
                    </li>
                  </ul>
                </li>
                <li className="submenu">
                  ...
                  <ul style={{ display: "none" }} className="menu-items2">
                    <li>
                      <Link className={props?.activeClassName === 'patient-list' ? 'active' : ''} to="/patientslist">Lista de Pacientes</Link>
                    </li>
                    <li>
                      <Link className={props?.activeClassName === 'add-patient' ? 'active' : ''} to="/addpatients">Agregar Pacientes</Link>
                    </li>
                    {/* <li>
                      <Link className={props?.activeClassName === 'edit-patient' ? 'active' : ''} to="/editpatients">Editar Pacientes</Link>
                    </li> */}
                    <li>
                      <Link className={props?.activeClassName === 'patient' ? 'active' : ''} to="/patientsprofile">Perfil Paciente</Link>
                    </li>
                  </ul>
                </li>
                {/* <li className="submenu">
                ...
                <li className="submenu">
                  ...
                  <ul style={{ display: "none" }} className="menu-items4">
                    <li>
                      <Link className={props?.activeClassName === 'appoinment-list' ? 'active' : ''} to="/appoinmentlist">Lista de Citas</Link>
                    </li>
                    <li>
                      <Link className={props?.activeClassName === 'add-appoinment' ? 'active' : ''} to="/addappoinments">Agregar Cita</Link>
                    </li>
                    <li>
                      <Link className={props?.activeClassName === 'add-first-appoinment' ? 'active' : ''} to="/addfirstappoinment">Agregar Entrevista</Link>
                    </li>
                    {/* <li>
                ...
                <li className="submenu">
                  ...
                  <ul style={{ display: "none" }} className="menu-items5">
                    <li>
                      <Link className={props?.activeClassName === 'shedule-list' ? 'active' : ''} to="/schedulelist">Lista de Horarios</Link>
                    </li>
                    <li>
                      <Link className={props?.activeClassName === 'add-shedule' ? 'active' : ''} to="/addschedule">Agregar Horarios</Link>
                    </li>
                    {/* <li>
                ...
                {/* <li className="submenu">
                  ...
                  <ul style={{ display: "none" }} className="menu-items11">
                    <li>
                      <Link className={props?.activeClassName === 'blog-grid' ? 'active' : ''} to="/blogview">Blog View</Link>
                    </li>
                    <li>
                      <Link className={props?.activeClassName === 'blog-details' ? 'active' : ''} to="/blog/1">
                        Blog
                      </Link>
                    </li>
                    <li>
