...
//   // const APPOINMENT_URL = import.meta.env.VITE_APPOINTMENTS_API + `/api/appointments`
...
//   const data = await fetch(import.meta.env.VITE_APPOINTMENTS_API + `/api/appintsimple/${id}`)
//   try {
//     const response = await data.json()
...
//   const APPOINMENT_URL = import.meta.env.VITE_APPOINTMENTS_API + `/api/appointments/${id}`
...
// export const fetchAppointment = async (id) => {
//   const APPOINMENT_API = import.meta.env.VITE_APPOINTMENTS_API + `/api/appointments/${id}`
...
export const createAppointment = async (appointment) => {
  const APPOINMENT_API = import.meta.env.VITE_APPOINTMENTS_API
...
export const updateAppointment = async (appointment, id) => {
  const APPOINTMENT_API = import.meta.env.VITE_APPOINTMENTS_API
