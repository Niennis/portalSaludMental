export const fetchUsers = async () => {
  ...
  const USERS_API = import.meta.env.VITE_SHOW_PATIENTS
...
export const fetchUser = async (id) => {
  ...
  // console.log(id);
  const USERS_API = import.meta.env.VITE_SHOW_PATIENT_BY_ID
  const data = await fetch(USERS_API, {
    method: 'POST',
    headers: {
      'content-type': 'application/json',
...
export const fetchUserMailAndPass = async (user) => {
  const USERS_API = import.meta.env.VITE_USERS_VALIDATE_USER
  const data = await fetch(USERS_API, {
    method: "POST",
    headers: {
      'content-type': 'application/json',
...
export const addUsers = async (user) => {
  ...
  // const USERS_API = import.meta.env.VITE_USERS_API + `/api/users`
  const USERS_API = import.meta.env.VITE_CREATE_PATIENTS
  const data = await fetch(USERS_API, {
    method: "POST",
    cors: "no-cors",
    headers: {
